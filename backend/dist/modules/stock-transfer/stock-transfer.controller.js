...
let StockTransferController = class StockTransferController {
    ...
    findAll(status) { return this.transferService.findAll(status); }
    findOne(id) { return this.transferService.findOne(id); }
    create(dto, req) { return this.transferService.create(dto, req.user.sub); }
    post(id, req) { return this.transferService.post(id, req.user.sub); }
};
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], StockTransferController.prototype, "post", null);
