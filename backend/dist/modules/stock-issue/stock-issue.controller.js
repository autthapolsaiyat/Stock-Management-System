...
let StockIssueController = class StockIssueController {
    ...
    findAll(status) { return this.issueService.findAll(status); }
    findOne(id) { return this.issueService.findOne(id); }
    create(dto, req) { return this.issueService.create(dto, req.user.sub); }
    post(id, req) { return this.issueService.post(id, req.user.sub); }
};
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], StockIssueController.prototype, "post", null);
exports.StockIssueController = StockIssueController = __decorate([
    (0, swagger_1.ApiTags)('Stock Issues'),
