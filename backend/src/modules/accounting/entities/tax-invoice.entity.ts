...
export class TaxInvoiceEntity {
  ...
  @OneToMany(() => TaxInvoiceLineEntity, (line) => line.taxInvoice, { cascade: true, eager: true })
  lines: TaxInvoiceLineEntity[];
...
export class TaxInvoiceLineEntity {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @ManyToOne(() => TaxInvoiceEntity, (invoice) => invoice.lines, { onDelete: 'CASCADE' })
  @JoinColumn({ name: 'tax_invoice_id' })
  taxInvoice: TaxInvoiceEntity;
