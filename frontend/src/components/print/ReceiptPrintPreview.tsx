...
interface ReceiptPrintPreviewProps {
  open: boolean;
  onClose: () => void;
  invoice: any; // Using invoice data for receipt
}
  ...
  return (
    ...
    >
      {loading ? (
        ...
        <div id="receipt-print-content" style={{ padding: 20, background: '#fff', fontSize: 14 }}>
          {/* Header */}
            ...
            <tbody>
              <tr>
                ...
                <td style={{ verticalAlign: 'top', border: 'none', padding: '0 10px' }}>
                  ...
                  <div style={{ fontSize: 12 }}>Tel. {companySettings.COMPANY_PHONE_EN || '(662) 886-9200-7'}</div>
          ...
          {/* Title */}
          <div style={{ textAlign: 'center', fontSize: 22, fontWeight: 'bold', margin: '15px 0', borderTop: '2px solid #000', borderBottom: '2px solid #000', padding: '10px 0', background: '#f0f0f0' }}>
            ...
            <tbody>
              <tr>
                <td style={{ width: '60%', verticalAlign: 'top', border: '1px solid #000', padding: 10 }}>
                  <div><strong>ได้รับเงินจาก / Received from:</strong></div>
                ...
                <td style={{ width: '40%', verticalAlign: 'top', border: '1px solid #000', padding: 10 }}>
                  <div><strong>เลขที่ใบเสร็จ:</strong> RCP-{invoice?.docFullNo?.replace('INV', '') || '-'}</div>
                  <div><strong>วันที่รับเงิน:</strong> {formatDate(invoice?.paidAt)}</div>
                  <div><strong>อ้างอิงใบแจ้งหนี้:</strong> {invoice?.docFullNo || '-'}</div>
              ...
              <tr>
                <td style={{ border: '1px solid #000', padding: 15 }}>
                  ...
                  <table style={{ width: '60%', margin: '0 auto', borderCollapse: 'collapse' }}>
                    <tbody>
                      <tr>
                        <td style={{ border: '1px solid #000', padding: 8, width: '50%' }}>มูลค่าสินค้า/บริการ</td>
                        <td style={{ border: '1px solid #000', padding: 8, textAlign: 'right' }}>{formatNumber(invoice?.subtotal || 0)}</td>
                      </tr>
                      <tr>
                        <td style={{ border: '1px solid #000', padding: 8 }}>ภาษีมูลค่าเพิ่ม 7%</td>
                        <td style={{ border: '1px solid #000', padding: 8, textAlign: 'right' }}>{formatNumber(invoice?.taxAmount || 0)}</td>
                      </tr>
                      <tr style={{ background: '#f0f0f0' }}>
                        <td style={{ border: '1px solid #000', padding: 10, fontWeight: 'bold', fontSize: 16 }}>จำนวนเงินรวมทั้งสิ้น</td>
                        <td style={{ border: '1px solid #000', padding: 10, textAlign: 'right', fontWeight: 'bold', fontSize: 16 }}>{formatNumber(invoice?.grandTotal || 0)}</td>
                      </tr>
                    </tbody>
                  </table>

                  <div style={{ textAlign: 'center', fontSize: 18, fontWeight: 'bold', marginTop: 15, padding: 10, border: '2px solid #000', background: '#fff' }}>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: 15 }}>
            <tbody>
              <tr>
                <td style={{ border: '1px solid #000', padding: 10, width: '50%' }}>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <tbody>
              <tr>
                <td style={{ width: '50%', border: '1px solid #000', padding: 20, textAlign: 'center', height: 120 }}>
                  <div style={{ marginBottom: 50 }}>ผู้ชำระเงิน / Payer</div>
                  <div>(..........................................)</div>
                  <div>วันที่ ......./......./.......</div>
                </td>
                <td style={{ width: '50%', border: '1px solid #000', padding: 20, textAlign: 'center' }}>
